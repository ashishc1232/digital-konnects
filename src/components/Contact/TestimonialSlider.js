...
const testimonials = [
  {
    client: "Jindal Steel",
    text: `When we approached Digital-Konnect, what we had was a jindal steel app and website whose conversion rate was dwindling for quite some time. We weren’t able to identify the issue, but we needed quick help. The time and effort that the team spent behind our application, not just identified the issue but also eradicated it from scratch.`,
  },
  {
    client: "ExpertBuddy",
    text: `When we approached Digital-Konnect, what we had was a ExpertBuddy  app and website whose conversion rate was dwindling for quite some time. We weren’t able to identify the issue, but we needed quick help. The time and effort that the team spent behind our application, not just identified the issue but also eradicated it from scratch.`,
  },
  {
    client: "Nesto-Hub",
    text: `When we approached Digital-Konnect, what we had was a Nesto-Hub app and website whose conversion rate was dwindling for quite some time. We weren’t able to identify the issue, but we needed quick help. The time and effort that the team spent behind our application, not just identified the issue but also eradicated it from scratch.`,
  },
];
    ...
    <div className="w-full bg-gray-50 py-10 px-4 md:px-10 lg:px-20 lg:mt-32 2xl:mt-4 flex justify-center items-center flex-col ">
      ...
      <div className="w-full max-w-7xl flex flex-col lg:flex-row items-center justify-between">
        <div className="w-full lg:w-1/3 mb-8 lg:mb-0 text-center lg:text-left">
          ...
          <button className="mt-4 py-2 px-4 text-sm bg-black text-white font-semibold rounded-lg hover:bg-black">
            Talk to our Experts
          </button>
        </div>
        ...
        <div className="w-full lg:w-2/3 relative bg-white p-6 rounded-lg shadow-lg">
          ...
          <div className="absolute bottom-4 right-4 flex space-x-4">
            <button
              className="swiper-custom-button p-2 bg-gray-200 rounded-full hover:bg-black hover:text-white transition z-10"
