...
const SemAgency = () => {
  const processes = [
    {
      ...
      desc: 'digitalkonnect, a leading SEM firm, has a seasoned staff with years of experience in developing efficient search engine marketing strategies that produce measurable results.',
    },
    {
      id: '2',
    ...
    },
    {
      ...
      desc: 'digitalkonnect, a top search engine marketing business, uses advanced tools and technologies to do comprehensive keyword research, competitor analysis, and performance tracking.',
    },
    {
      id: '5',
    ...
    },
    {
      id: '6',
      name: 'Proven Success',
      desc: 'digitalkonnect has a proven track record as the finest search engine marketing business, continuously delivering great results, increasing traffic, leads, and conversions for our clients.',
    },
  ];
  const techs = [
    {
  ...
  const cards = [
    {
      id: 1,
      para: 'Digital-Konnect, a top SEM company in Gurgaon, offers full search engine marketing services. We specialize in keyword research, ad production, bid management, and conversion optimisation to ensure maximum ROI and business growth.',
      bgcolor: 'bg-[#fff]',
      cols: 'md:col-span-2',
  ...
  return (
    <div>
      <Head>
        <title>Search Engine Marketing services in USA | Digital-Konnect</title>
        <meta
          name="description"
          content="Looking for the best Search Engine Marketing services in USA to help you achieve optimum results and improve your ROI? Look no further than digitalkonnect."
        />
        <link
          rel="canonical"
          href="https://www.digitalkonnect.com/sem-agency-in-USA"
        />
        <meta
          property="og:title"
          content="Search Engine Marketing services in USA | digitalkonnect"
        />
        <meta
  ...
  "description": "Looking for the best Search Engine Marketing agency in USA to help you achieve optimum results and improve your ROI? Look no further than digitalkonnect",
  "isPartOf": {
    "@id": "#website"
  },
  "about": [
  ...
  "mentions": [
    {
      ...
      >
        <Banner
          bannertitle="digitalkonnect: Gurgaon's Best Search Engine Marketing Services"
          bannersubtext="Welcome to digitalkonnect, your go-to source in Gurgaon for innovative Search Engine Marketing (SEM) services. As a top SEM firm, we offer unmatched experience and brilliant ideas to increase your brand's online visibility and produce significant outcomes."
          serviceimg="/assets/images/service/svg/eng.png"
          serviceimgAlt="search engine marketing company"
          servicehead="Manifest the Might of SEM with digitalkonnect: Your Trusted SEM Agency"
          servicedesc1=" We at digitalkonnect are your growth catalyst, not simply another provider of SEM services in Gurgaon. Our complete approach to SEM encompasses all facets of the practice, from campaign optimisation and performance evaluation to keyword research and ad production. We guarantee that your investment in SEM produces measurable results by placing a strong emphasis on maximizing ROI. As the top search engine marketing firm in Gurgaon."
        ...
        >
          <div className="px-5 container-ack md:px-0">
            <ProccessHead
              ...
              processdesc="digitalkonnect is your go-to SEM partner for experienced ideas, tailored approaches, data-driven insights, novel tools, transparent reporting, and a track record of generating successful search engine marketing campaigns."
