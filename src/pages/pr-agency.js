...
const PrAgency = () => {
  ...
  const cards = [
    {
      id: 1,
      para: "Digital-Konnect, a renowned PR agency in USA, can help you boost your brand's visibility. Media relations, crisis management, content production, influencer alliances, event publicity, and strategic social media skills are all part of our comprehensive offerings.",
      bgcolor: 'bg-[#fff]',
      cols: 'md:col-span-2',
  ...
  return (
    <div>
      ...
      >
        <Banner
          bannertitle="Get Noticed with PR: Digital-Konnect, the Best PR Agency in USA"
          bannersubtext="Digital-Konnect is the top PR firm in USA, thanks to a devoted team of specialists who understand the ever-changing communication landscape. We are dedicated to providing strategic solutions that not only increase the visibility of your business but also create significant interactions."
          serviceimg="/assets/images/service/svg/pr.png"
          serviceimgAlt="public relations agency"
          servicehead="Raise Your Brand's Voice with Digital-Konnect USA's Best PR Agency"
          servicedesc1="Welcome to Digital-Konnect, your dependable Public Relations partner. We specialise in building and amplifying captivating narratives that resonate with your target audience as a top PR agency in USA. Our mission is to help companies become influential voices by connecting them with customers, stakeholders, and the media."
