...
const SmmAgency = () => {
  const processes = [
    {
      ...
      desc: 'Digital-Konnect, the top social media marketing firm in Gurgaon, provides unmatched knowledge and precise tactics.',
    },
    {
      id: '2',
    ...
    },
    {
      ...
      desc: 'Digital-Konnect, the top social media marketing company in Gurgaon, creates strategies specifically to meet the requirements of each customer.',
    },
    {
      id: '5',
    ...
    },
    {
      ...
      desc: 'For data-driven insights and effective brand expansion, pick Digital-Konnect, the top social media marketing company in Gurgaon.',
    },
  ];
  const techs = [
    {
  ...
  const cards = [
    {
      ...
      display: 'hidden',
      maintitle: 'Services',
      subtitle: 'Our Exemplary Social Media Marketing Services in USA ',
    },
    {
      id: 2,
      icon: '01',
  ...
  return (
    <div>
      <Head>
        <title> Social Media Marketing services in USA | Digital-Konnect </title>
        <meta
          name="description"
          content="Digital-Konnect: best social media marketing sevices in USA! we are specializes in strategic solutions to boost your online presence and drive impactful results."
        />
        <link
          rel="canonical"
          href="https://www.digitalkonnect.com/social-media-marketing-company-in-USA"
        />
        <meta
          property="og:title"
          content=" Social Media Marketing services in USA | Digital-Konnect"
        />
        <meta
          property="og:description"
          content="Digital-Konnect: Digital-Konnect: best social media marketing sevices in USA! we are specializes in strategic solutions to boost your online presence and drive impactful results."
        />
        <meta
          property="og:url"
          content="https://www.digitalkonnect.com/social-media-marketing-company-in-USA"
        />
        <meta
          property="og:image"
          content="https://www.digitalkonnect.com/assets/images/service/svg/med.png"
        />
  ...
  "@type": "WebPage",
  "@id": "https://www.digitalkonnect.com/social-media-marketing-company-gurgaon#webpage",
  "url": "https://www.digitalkonnect.com/social-media-marketing-company-gurgaon",
  "inLanguage": "en - US",
  "name": "Social Media Marketing",
  "description": "Digital-Konnect: best social media marketing company in USA! we are  specializes in strategic solutions to boost your online presence and drive impactful results.",
  "isPartOf": {
    "@id": "#website"
  },
  "about": [
  ...
  "mentions": [
    {
      ...
      >
        <Banner
          bannertitle="Craft Digital Success with our Premium Social Media Marketing Services in USA"
          bannersubtext="Welcome to Digital-Konnect, Gurgaon's premier provider of first-rate social media marketing services. We take great pleasure in our ability to connect brands with their audience in meaningful and effective ways as a top social media marketing company. "
          serviceimg="/assets/images/service/svg/med.png"
          serviceimgAlt="social media marketing agency"
          servicehead="Increase the Impact of Your Brand with our Digital-Konnect Social media marketing services"
          servicedesc1="Digital-Konnect is best social media marketing services in USA that provides innovative and effective solutions to businesses aiming to harness the power of social media for growth and success. With a dedicated team of social media experts and a deep understanding of social media."
        ...
        >
          <div className="px-5 container-ack md:px-0">
            <ProccessHead
              ...
              processdesc="Digital-Konnect distinguishes itself as the top social media marketing company in Gurgaon thanks to our go-to tactics, focused targeting, dependable outcomes, personalised approach, all-inclusive solutions, and strategic insights."
